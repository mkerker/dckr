...
Open a command-line terminal *(for Windows try PowerShell or install [Cygwin](https://cygwin.com/install.html))* and try out some Docker commands. Or if you use play-with-docker press +ADD NEW INSTANCE.
